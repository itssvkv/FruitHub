...
import 'package:fruit_app/features/checkout/domain/entites/paypal_payment_entity/paypal_payment_entity.dart';
...
class _CheckoutViewBodyState extends State<CheckoutViewBody> {
            ...
            onTap: (index) {
              if (currentPageIndex == 0) {
                ...
                if (orderEntity.payWithCash != null) {
                  ...
                  customSnackBar(context, 'يرجي تحديد طريقه الدفع');
                }
              } else {
  ...
  void _processPayment(BuildContext context) {
    ...
    //       Navigator.pop(context);
    //       log(error.toString());
    //       customSnackBar(context, 'حدث خطأ في عملية الدفع');
    //     },
    //     onCancel: () {
    //       print('cancelled:');
    //     },
